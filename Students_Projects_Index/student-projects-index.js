...
const projects = {
    ...
    '12d': [
        ...
        },
        {
            ...
            description: "Нашият сайт предлага различни козметични продукти, като грим и грижа за кожата. Има богат избор от висококачествени артикули, с които да изглеждате прекрасно. ",
            tags: ["HTML", "CSS"],
